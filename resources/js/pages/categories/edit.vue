<template>
  <FormPage :page="page" formId="category-form" @submit="form.put(`/cp/categories/${collection.id}`)">
    <Card title="General">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <Input v-model="form.title" label="Title" :error="form.errors.title" placeholder="Category name" required />
...
const props = defineProps({ page: Object, collection: Object, parents: Array })
...
const form = useForm({
  ...
  parent_id: props.collection?.parent_id || null,
})
