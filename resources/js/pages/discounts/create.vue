<template>
  <FormPage :page="page" formId="discount-form" @submit="form.post('/cp/discounts')">
    <Card title="General">
...
defineProps({ page: Object, discount_types: Array })

const form = useForm({
  name: '', code: '', description: '', type: 'percentage', value: null,
  minimum_order_amount: null, maximum_discount_amount: null,
  usage_limit: null, usage_limit_per_customer: null,
  starts_at: '', expires_at: '', is_enabled: true,
})
