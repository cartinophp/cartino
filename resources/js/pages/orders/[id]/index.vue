...
.status-label { font-size: 0.875rem; color: #6b7280; }
.address-block { font-style: normal; font-size: 0.875rem; line-height: 1.6; color: #374151; }
.notes-text { font-size: 0.875rem; color: #374151; margin: 0; }
</style>
